...
<div class="container">
  ...
  <a href="{{url('myshow')}}" class="btn btn-secondary btn-number">
  ...
  <a href="{{url('friends')}}" class="btn btn-secondary btn-number">
  ...
  <a href="{{url('profile')}}" class="btn btn-secondary btn-number">
